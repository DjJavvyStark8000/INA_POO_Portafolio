...
{
    public class EntidadMedicos : Persona
    {
        ...
        public EntidadMedicos(int funcionarioId, string puesto, string nombreFuncionario, string apellidos, string fechaNacimiento,
