   ...
   public class DAPlataforma
    {
        ...
        public int EliminarPlataforma(int plataformaId)
        {
            int id = 0;
            ...
            using (SqlConnection cnx = new SqlConnection(_cadenaConexion))
            {
                ...
                SqlCommand comando = new SqlCommand();
                comando.Connection = cnx;
                string ruta = "DELETE FROM PLATAFORMA WHERE PLATAFORMA_ID = @PLATAFORMA_ID";

                comando.Parameters.AddWithValue("@PLATAFORMA_ID", plataformaId);
                comando.CommandText = ruta;
                try
                {
                    cnx.Open();
