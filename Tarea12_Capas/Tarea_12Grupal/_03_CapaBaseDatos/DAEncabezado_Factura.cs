...
namespace _03_CapaBaseDatos
{
    internal class DAEncabezado_Factura
    {
        ...
        public DAEncabezado_Factura(int id_factura, DateTime fecha, int id_cliente, double subtotal, double impuesto, double monto_descueno)
        {
